...
HD_PWD='C:/Users/Exusisa/Desktop/UCAS_Digital_IC/multiply/multiply.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mul.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_mul.tcl -notrace
