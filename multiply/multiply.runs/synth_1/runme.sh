...
HD_PWD='G:/Vivado/multiply/multiply.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_mul.tcl
