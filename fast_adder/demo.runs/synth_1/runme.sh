...
HD_PWD='G:/Vivado/demo/demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log carry_lookahead_adder_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source carry_lookahead_adder_32.tcl
