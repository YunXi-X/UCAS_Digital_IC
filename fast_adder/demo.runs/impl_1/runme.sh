...
HD_PWD='G:/Vivado/demo/demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log carry_lookahead_adder_32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source carry_lookahead_adder_32.tcl -notrace
