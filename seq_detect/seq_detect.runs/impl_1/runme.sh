...
HD_PWD='G:/Vivado/seq_detect/seq_detect.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_detect_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seq_detect_tb.tcl -notrace
