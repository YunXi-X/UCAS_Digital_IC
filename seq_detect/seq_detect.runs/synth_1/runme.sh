...
HD_PWD='G:/Vivado/seq_detect/seq_detect.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_detect_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_detect_tb.tcl
